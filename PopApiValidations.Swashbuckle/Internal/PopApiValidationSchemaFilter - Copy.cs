...
//    //{
//    //    ValidationNameAppend = ((matchesMethodParam)? string.Empty: parameterInfo.ParamName) + (isArray? config.OrdinalIndicator : string.Empty);
//    //    OpenApiParamName = openApiParam.Name + (isArray ? config.OrdinalIndicator : string.Empty);
//    //    Operation = operation;
...
//    public static OpenApiValidationParam ForNonQueryParam(
//        PopApiOpenApiConfig config,
//        bool isArray,
//        bool matchesMethodParam,
//        OpenApiOperation operation,
...
//        OpenApiSchema parameterSchema)
//    {
//        return new OpenApiValidationParam
//        {
//            ValidationNameAppend = ((matchesMethodParam) ? string.Empty : parameterInfo.ParamName),// + (isArray ? config.OrdinalIndicator : string.Empty),
//            OpenApiParamName = openApiParam.Name,// + (isArray ? config.OrdinalIndicator : string.Empty),
//            IsArray = isArray,
...
//    public static OpenApiValidationParam ForQueryParam(
//        PopApiOpenApiConfig config,
//        bool isArray,
//        OpenApiOperation operation,
//        OpenApiParameter openApiParam,
...
//        return new OpenApiValidationParam
//        {
//            ValidationNameAppend = openApiParam.Name,// string.Empty,// + (isArray ? config.OrdinalIndicator : string.Empty),
//            OpenApiParamName = openApiParam.Name,// + (isArray ? config.OrdinalIndicator : string.Empty),
//            IsArray = isArray,
//            Operation = operation,
//            OpenApiParam = openApiParam,
...
//    public static OpenApiValidationParam ForRequestBody(
//        PopApiOpenApiConfig config,
//        bool isArray,
//        bool matchesMethodParam,
//        OpenApiOperation operation,
...
//        {
//            ValidationNameAppend = ((matchesMethodParam) ? string.Empty : parameterInfo.ParamName),// + (isArray ? config.OrdinalIndicator : string.Empty),
//            OpenApiParamName = "RequestBody" + (isArray ? config.OrdinalIndicator : string.Empty),
//            IsArray = isArray,
//            Operation = operation,
//            MethodInfo = methodInfo,
//            ParamType = parameterInfo.ParameterType,
...
//    protected OpenApiValidationParam() { }

//    public bool IsArray { get; set; }
//    public string ValidationNameAppend { get; init; }
//    public string OpenApiParamName { get; init; }
//    public OpenApiOperation Operation { get; init; }
//    public OpenApiParameter OpenApiParam { get; init; }
//    public MethodInfo? MethodInfo { get; init; }
//    public Type ParamType { get; init; }
//    public FunctionParameter? ParameterInfo { get; init; }
//    public OpenApiSchema ParameterSchema { get; init; }
//    public OpenApiRequestBody? ParamRequestBody { get; init; }
...
//            newModels.Add(OpenApiValidationParam.ForNonQueryParam(
//                config: config,
//                isArray: p.Schema.Items != null,
//                matchesMethodParam: string.Equals(foundParam.ParamName, p.Name, StringComparison.OrdinalIgnoreCase),
//                //matchesMethodParam: ,
//                //matchesMethodParam:,
//                //validationNameAppend: (string.Equals(foundParam.ParamName, p.Name, StringComparison.OrdinalIgnoreCase))? string.Empty : foundParam.ParamName,
//                operation: operation,
//                openApiParam: p,
//                methodInfo: context.MethodInfo,
//                parameterInfo: foundParam,
//                parameterSchema: p.Schema
//            ));
//        }
...
//            newModels.Add(OpenApiValidationParam.ForQueryParam(
//                config: config,
//                isArray: queryParam.Schema.Items != null,
//                //matchesMethodParam: string.Equals(foundParam.ParamName, queryParam.Name, StringComparison.OrdinalIgnoreCase),
//                //validationNameAppend: (string.Equals(foundParam.ParamName, queryParam.Name, StringComparison.OrdinalIgnoreCase)) ? string.Empty : queryParam.Name,
//                operation,
//                queryParam,
//                context.MethodInfo,
//                foundParam,
...
//                newModels.Add(OpenApiValidationParam.ForRequestBody(
//                    config: config,
//                    isArray: c.Schema.Items != null,
//                    matchesMethodParam: string.Equals(foundParam.ParamName, foundcontentparam.Name, StringComparison.OrdinalIgnoreCase),
//                    //validationNameAppend: string.Empty,
//                    operation,
//                    context.MethodInfo,
//                    foundParam,
//                    c.Schema.Reference != null ? context.SchemaRepository.Schemas[c.Schema.Reference.Id] : c.Schema,
...
//            //);
//            if (!string.IsNullOrWhiteSpace(model.ValidationNameAppend))
//            {
//                desc += config.ChildIndicator + model.ValidationNameAppend;
//            }
//            var enumerableDesc = desc + config.OrdinalIndicator;
...
//            if (allenumerableresults.Any())
//            {
//                model.IsArray = true;
//                RunParameterRule(
//                    model,
//                    enumerableDesc,
//                    allenumerableresults,
//                    context.SchemaRepository,
//                    ValidationLevel.FullDetails
//                );
//            }
...
//    OpenApiSchema GetSchema(SchemaRepository schemaRepository,)
...
//    private static List<(string GroupTitle, DescriptionOutcome Outcome)> FlattenOutcomes(
//        OpenApiConfig config, 
