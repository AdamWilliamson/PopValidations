...
public static class IsGreaterThanOrEqualToTestSetup
{
    ...
    public class RequestValidator : AbstractValidator<Request>
    {
        ...
        {
            Describe(x => x.Id).IsGreaterThanOrEqualTo(5);
            Describe(x => x.Name).Vitally().IsGreaterThanOrEqualTo("Test");
    ...
    public class SubRequestValidator : AbstractSubValidator<SubRequest>
    {
        ...
        {
            Describe(x => x.Id).IsGreaterThanOrEqualTo(6);
            Describe(x => x.Name).Vitally().IsGreaterThanOrEqualTo("Test2");
        }
    }
}