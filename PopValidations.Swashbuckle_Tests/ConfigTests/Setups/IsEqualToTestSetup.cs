...
public static class IsEqualToTestSetup
{
    ...
    public class RequestValidator : AbstractValidator<Request>
    {
        ...
        {
            Describe(x => x.Id).IsEqualTo(5);
            Describe(x => x.Name).Vitally().IsEqualTo("Test");
    ...
    public class SubRequestValidator : AbstractSubValidator<SubRequest>
    {
        ...
        {
            Describe(x => x.Id).IsEqualTo(6);
            Describe(x => x.Name).Vitally().IsEqualTo("Test2");
        }
    }
}