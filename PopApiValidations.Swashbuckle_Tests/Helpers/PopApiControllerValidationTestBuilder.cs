    ...
    where TValidator : ApiValidator<TController>, new()
{
    ...
    internal void ReplaceRegistration<TInterface, TOld, TNew>(TNew instance)
    {
        setup.ReplaceRegister<TInterface, TOld, TNew>(instance);
        OpenApiSetup.ReplaceRegister<TInterface, TOld, TNew>(instance);
    }
}
