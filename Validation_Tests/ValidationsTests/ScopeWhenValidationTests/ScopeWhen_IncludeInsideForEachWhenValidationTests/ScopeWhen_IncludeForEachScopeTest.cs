...
namespace PopValidations_Tests.ValidationsTests.ScopeWhenValidationTests.ScopeWhen_IncludeInsideForEachWhenValidationTests;
...
public class ScopeWhen_IncludeForEachScopeTest
{
    [Fact]
