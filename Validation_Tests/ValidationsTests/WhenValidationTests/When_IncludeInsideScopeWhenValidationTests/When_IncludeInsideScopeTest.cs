...
namespace PopValidations_Tests.ValidationsTests.WhenValidationTests.When_IncludeInsideScopeWhenValidationTests;
...
public class When_IncludeInsideScopeTest
{
    [Fact]
